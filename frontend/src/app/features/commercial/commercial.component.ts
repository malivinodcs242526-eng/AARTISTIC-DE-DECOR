  ...
  template: `
    <div class="container mx-auto px-4 lg:px-8 py-16">
      <div class="mb-12">
        ...
        <h1 class="text-4xl md:text-5xl font-bold">Commercial Projects</h1>
        <p class="text-zinc-600 dark:text-gray-400 mt-4 max-w-2xl transition-colors duration-300">Discover our visionary approach to commercial spaces, blending aesthetics with functionality to elevate brand experiences.</p>
      </div>
...
export class CommercialComponent implements OnInit {
  ...
  ngOnInit() {
    this.projectService.getProjects('commercial').subscribe({
      next: (res) => {
